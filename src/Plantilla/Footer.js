...
export const Footer = () => {
  return (
    <div className="shadow footer bg-dark">
      <CDBBox
        display="flex"
      ...
      >
        <CDBBox display="flex" alignItems="center">
          <a href="/" className="d-flex align-items-center p-0 text-ligth">
            <img
              alt="logo"
              ...
              width="30px"
            />
            <span className="ms-4 h5 mb-0 font-weight-bold">Proyecto React</span>
          </a>
          <small className="ms-2 text-light">Integrantes: Geovanny/Lau/Jeff </small>
        </CDBBox>
        <CDBBox display="flex">
